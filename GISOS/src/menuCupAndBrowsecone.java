...
public class menuCupAndBrowsecone extends JFrame {
	...
	public menuCupAndBrowsecone() {
		...
		SpinnerNumberModel model2 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model3 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model4 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model5 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model6 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model7 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model8 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model9 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model10 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model11 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model12 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model13 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model14 = new SpinnerNumberModel(0, 0, 4, 1);  
		SpinnerNumberModel model15 = new SpinnerNumberModel(0, 0, 4, 1);  
